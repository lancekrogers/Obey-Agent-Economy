...
fest_managed: true
fest_created: 2026-03-31T17:16:09.201144-06:00
fest_updated: 2026-04-01T03:14:08.219808-06:00
fest_tracking: true
fest_version: "1.0"
---
...
`cd projects/agent-inference && go test ./...`
...
`cd projects/agent-inference && go test -tags live ./...`
...
`cd projects/agent-inference && go test -coverprofile=coverage.out ./... && go tool cover -func=coverage.out`
