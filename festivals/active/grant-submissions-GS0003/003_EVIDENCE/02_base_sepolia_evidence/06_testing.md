...
fest_managed: true
fest_created: 2026-03-31T17:16:12.708174-06:00
fest_updated: 2026-04-01T03:16:57.924455-06:00
fest_tracking: true
fest_version: "1.0"
---
...
`cd projects/agent-defi && go test ./...`
...
`cd projects/agent-defi && go test -tags live ./...`
...
`cd projects/agent-defi && go test -coverprofile=coverage.out ./... && go tool cover -func=coverage.out`
